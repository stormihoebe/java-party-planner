...
public class Party{
  ...
  private double mFoodChoice; //0 = no food (g*0), 1 = light snacks(g*2), 2 = hd (g*3), 3 = pizza (g*4), 4 = meal (g*15)
  private double mDrinkChoice; //0 = no drinks (g*0), 1 = tea & coffee (g*1), 2 = beer (g*5), 3 = bar (g*10)
  private double mEntertainmentChoice; //0 = entertainment, 1 = DJ (+100), 2 = clowns (+30), 3 = Magician (+60), 4 = speaker (+200)
  private String mCoupon; // SUPERDEAL20 20%off, DJDISCOUNT30 $30off with DJ, MAGICALMAYHEM free Magician

  public Party(double guest, double food, double drink, double entertainment, String coupons) {
    mGuests = guest;
    mFoodChoice = food;
    mDrinkChoice = drink;
